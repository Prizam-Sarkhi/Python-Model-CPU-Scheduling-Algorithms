...
if __name__=="__main__":
    ...
    for w,p in WORKLOADS.items():
        allres.extend(run_algorithm(FCFSScheduler,w,p))
    ...
    export_csv(allres,"results/fcfs_raw.csv",
               columns=["Algorithm","Workload","Avg_TAT","Avg_WT","Avg_RT"])
    export_csv(avgdata,"results/fcfs_averaged.csv",
               columns=["Algorithm","Workload","Avg_TAT","Avg_WT","Avg_RT"])
    print("Saved results for FCFS")
